                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ListView.builder(
                              itemCount: o.state.watchList.length,
                              // itemCount: o.state.watchList.length,
                              itemBuilder: (context, i) {
                                return InkWell(
                                  onTap: () {
                                    Navigator.of(context).push(
                                        o.buildRoute(o.state.watchList[i]));
                                  },
                                  child: Container(
                                    ...
                                    child: Row(
                                      children: [
                                        InkWell(
                                          onTap: () {
                                            context.read<HomeProvider>().onTopfavoriteSaveIcon(
                                                o.state.iconWatch,
                                                i,
                                                o.state.watchList[i],
                                                context);
                                          },
                                          child: context.watch<HomeProvider>().state.iconWatch[i] == false
                                              ? Icon(Iconsax.heart,
                                              size: 20,
                                              shadows: const [
                                                BoxShadow(
