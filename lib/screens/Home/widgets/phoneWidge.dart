                      ...
                      children: [
                        SizedBox(
                          ...
                          child: ListView.builder(
                              itemCount: o.state.phoneList.length,
                              itemBuilder: (context, i) {
                                return InkWell(
                                  onTap: () {
                                    Navigator.of(context).push(
                                        o.buildRoute(o.state.phoneList[i]));
                                  },
                                  child: Container(
