                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ListView.builder(
                              itemCount: o.state.lapList.length,
                              // itemCount: o.state.lapList.length,
                              itemBuilder: (context, i) {
                                return InkWell(
                                  onTap: () {
                                    Navigator.of(context).push(
                                        o.buildRoute(o.state.lapList[i]));
                                  },
                                  child: Container(
                                    ...
                                    child: Row(
                                      children: [
                                        InkWell(
                                          ...
                                          child: context.watch<HomeProvider>()
                                              .state
                                              .iconLap[i] ==
                                              false
                                              ? Icon(Iconsax.heart,
